...
#                          enh_method='DC', wet_eff = 0.65, Kga = 'onda',recirc=True
#                          )
...
print()
print(f'The RMSE for the new model is {RMSE(gas_outlet_1, outlet_conc_gm3)}')
print(f'The RMSE for the new model cf 0.65 is {RMSE(gas_outlet_2, outlet_conc_gm3)}')
...
plt.plot(t_old/60, gas_outlet_old, color = 'grey', linestyle = '--', label = "Simple Model, cf = 0.86")
