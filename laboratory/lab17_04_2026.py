...
print()
print(f'The MAPD for M1,PFO {MAPD(gas_outlet_1, outlet_conc_gm3)}')
print(f'The MAPD for M1,DC {MAPD(gas_outlet_2, outlet_conc_gm3)}')
print()
print(print(f'THE MAPD for M2 is {MAPD(gas_outlet_old, outlet_conc_gm3)}'))
...
plt.plot(t_1/60, gas_outlet_1, 'r-', label = "Model, E = PFO")
plt.plot(t_2/60, gas_outlet_2, 'k-', label = "Model, E = Decursey")
plt.plot(t_old/60, gas_outlet_old, color = 'grey',linestyle = '--', label = "Simple Model" )
...
plt.plot(t_1/60, pH_outlet_1, 'r-', label = "Model, E = PFO")
plt.plot(t_2/60, pH_outlet_2, 'k-', label = "Model, E = DeCoursey")
...
plt.plot(t_1/60, removal_eff_vs_t_1, 'r-', label = 'M1, E = PFO')
plt.plot(t_2/60, removal_eff_vs_t_2, 'k-', label = 'M1, E = DeCoursey')
plt.plot(t_old/60, removal_eff_vs_t_old, color = 'grey',linestyle = '--', label = "M2" )
