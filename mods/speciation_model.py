...
def spec(TOTC,K1,K2,KW):
    def residC(c_h2co3):
        def residH(c_h):
            c_hco3  = (K1*c_h2co3)/c_h
            c_co3   = (K1*K2*c_h2co3)/c_h**2
            c_oh    = KW/c_h
...
def spec2(TOTC,K1,K2,KW):
    def residH(c_h):
            c_h2co3 = TOTC/(1 + K1/c_h + (K2*K1)/c_h**2)
            c_hco3  = (K1*c_h2co3)/c_h
            c_co3   = (K1*K2*c_h2co3)/c_h**2
            c_oh    = KW/c_h
            return c_h -  c_hco3 - 2*c_co3-c_oh
...
def spec2_matrix(TOTC,K1,K2,KW):
